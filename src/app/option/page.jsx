...
export default function OptionPage() {
    return (
        <div className="flex justify-center items-center h-[100vh] bg-[#FFF7F3]">
            <div className="flex justify-center bg-white w-[95%] rounded-xl border flex-col gap-10 px-5 h-[95%]">
                ...
                <div className="flex lg:gap-16 gap-5 flex-wrap justify-center items-center">
                    <Option />
                    <Option />
                </div>
            </div>
