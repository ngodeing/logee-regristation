...
export default function InfoSection() {
    return (
        <div className="flex flex-col gap-5 items-center justify-center">
            ...
            <Link href="/option" className="bg-[#FF5600] lg:px-5 lg:py-3 px-3 py-2 lg:text-lg text-sm rounded-md font-semibold mt-10 w-fit transition-all duration-100 ease-in-out transform hover:scale-110 hover:bg-[#ffffff] hover:text-[#FF5600] active:scale-95">
                Daftar Sekarang
            </Link>
        </div>
    );
